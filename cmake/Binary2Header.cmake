...
function(BIN2H)
    ...
    set(fileGuardBegin "#ifndef ${BIN2H_VARIABLE_NAME}_HEADER_FILE\n#define ${BIN2H_VARIABLE_NAME}_HEADER_FILE\n")
    set(fileGuardEnd "#endif // ${BIN2H_VARIABLE_NAME}_HEADER_FILE\n\n")

    set(arraySizeDefinition "#define SIZEOF_${BIN2H_VARIABLE_NAME}  ${arraySize}")

    set(arrayDefinition "const unsigned char ${BIN2H_VARIABLE_NAME}[ SIZEOF_${BIN2H_VARIABLE_NAME} ] = ${arrayValues};")


    set(declarations "${fileGuardBegin}\n\n${arraySizeDefinition}\n\n${arrayDefinition}\n\n${fileGuardEnd}\n")
    if (BIN2H_APPEND)
